...
public class TransactionController {
    ...
    public ResponseEntity<Transaction> withdrawAmount(@RequestBody TransactionDTO transactionDTO) {
        return new ResponseEntity<>(transactionService.withdrawAmount(userSession.getAuthenticatedUserId(), transactionDTO), HttpStatus.OK);
    }
    ...
    @PutMapping(value = "/deposit/{amount}", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Transaction> depositAmount(@PathVariable int amount) {
        return new ResponseEntity<>(transactionService.depositAmount(userSession.getAuthenticatedUserId(), amount), HttpStatus.OK);
    }
